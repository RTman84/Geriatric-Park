        ...
        <div className="fixed inset-0 z-[6000] flex items-center justify-center bg-black/60 p-5 backdrop-blur-sm">
          <div className="w-full max-w-md rounded-3xl bg-white p-6 shadow-2xl dark:bg-slate-900">
            <div className="mb-5 flex items-center justify-between">
              ...
              <button type="button" onClick={() => setOpen(false)} className="text-slate-300" aria-label="Close">✕</button>
            </div>
            ...
            {session ? (
              ...
              <div className="space-y-3">
                ...
                <div className="text-center text-[15px] font-black uppercase tracking-widest text-slate-300">or email</div>
                ...
                <div className="rounded-xl bg-amber-50 p-3 text-[15px] font-bold leading-relaxed text-amber-900">
